...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-5 text-left align-middle font-bold text-xs uppercase tracking-wider text-slate-500 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-5 py-4 align-middle text-sm text-slate-700 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
));
